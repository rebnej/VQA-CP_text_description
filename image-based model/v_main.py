...
from v_dataset import VQABERTDataset
import v_model
import utils
...
def parse_args():
    ...
    parser.add_argument('--output', type=str, default='saved_models/v_bertvqa')
...
#ここらへんは結果の再現性のためのコード
    ...
    model = getattr(v_model, constructor)(train_dset).cuda()
